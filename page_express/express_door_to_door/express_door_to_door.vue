...
<template>
	<view>
		<cu-custom bgColor="bg-gradual-blue" :isBack="true">
			...
			<block slot="content">送货上门状态</block>
		</cu-custom>
		<view class="wrap">
			...
			<swiper class="swiper-box" :current="swiperCurrent" @transition="transition" @animationfinish="animationfinish">
				...
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="reachBottom">
						<view class="page-box">
							<navigator url="../door_order_lookup_user/door_order_lookup_user" class="order" v-for="(res, index) in dataList1" :key="res.id">
								...
								<view class="item">
									...
									<view class="content">
										...
										<view class="delivery-time">快递员：{{ res.people }}{{ res.phone }}</view>
				...
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="reachBottom">
						<view class="page-box">
							<navigator url="../door_finished/door_finished" class="order" v-for="(res, index) in dataList2" :key="res.id">
