		...
		<view class="back-image">
			<view class="top" >
				...
				<view class="nav2" style="padding-bottom: 0;">
					...
					<navigator url="../mypackage_details/mypackage_details" class="order" v-for="(res, index) in dataList1" :key="res.id">
				...
				<view class="nav2" style="padding-bottom: 0;">
					...
					<view class="info-list" style="padding: 0;">
						<navigator url="../mypackage_details/mypackage_details" class="order" v-for="(res, index) in dataList2" :key="res.id">
