	...
	<view>
		...
		<view class="container">
			...
			<view class="requirement">
				...
				<view class="errorBox">
					<view class="item1">
						<image class="iconImg" src="http://p1362.bvimg.com/10465/836a821c07488ea0.png" mode="widthFix"></image>
					</view>
					<view class="item2">
						<image class="iconImg" src="http://p1362.bvimg.com/10465/bb30386ff69b926b.png" mode="widthFix"></image>
					</view>
					<view class="item3">
						<image class="iconImg" src="http://p1362.bvimg.com/10465/bb30386ff69b926b.png" mode="widthFix"></image>
					</view>
...
<style lang="scss" scoped>
	...
	.uploadBox {
		...
		.uploadItem {
			...
			.imgEx1 {
				background: url(http://p1362.bvimg.com/10465/3cfd4fe75041f153.png);
				background-size: 82%;
			...
			.imgEx2 {
				background: url(http://p1362.bvimg.com/10465/028d9b1e847b5581.png);
				background-size: 82%;
				background-repeat: no-repeat;
				background-position: center;
			}
	...
	.requirement {
		...
		.errorBox {
			...
			.item1 {
				background-image: url(http://p1362.bvimg.com/10465/df5dc032a14220bf.png);
				background-repeat: no-repeat;
				background-size: 100%;
				position: relative;
			}
			...
			.item2 {
				background-image: url(http://p1362.bvimg.com/10465/56329c9c81f7ccf6.png);
				background-repeat: no-repeat;
				background-size: 100%;
				position: relative;
			}
			...
			.item3 {
				background-image: url(http://p1362.bvimg.com/10465/ffdb4155da61f950.png);
				background-repeat: no-repeat;
				background-size: 100%;
				position: relative;
			}
			...
			.item4 {
				background-image: url(http://p1362.bvimg.com/10465/61785e9e058e5256.png);
				background-repeat: no-repeat;
				background-size: 100%;
				position: relative;
			}
