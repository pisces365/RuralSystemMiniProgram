...
<script>
	export default {
		data() {
			return {
				text: '',
				array: ['--请选择--','儿科','妇科','耳鼻喉科','神经科','呼吸科','血液科','消化科','胸外科','心外科','关节科'],
				index: 0,
				type: '--请选择--'
			}
		},
